            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">สัญชาติ</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header ">
                            <div class="d-flex">
                                <h3 class="card-title align-self-center">สัญชาติทั้งหมด</h3>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " id="nationality_name"
                                                    name="nationality_name" placeholder="ชื่อสัญาชาติ">
                                            </div>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="submit" name="nationality_add"
                                            ...
                                            ?>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="setup_nationality_edit.php?nationality_id=<?php echo $rows["nationality_id"]; ?>"
                                                            class="btn btn-warning"><i class="fas fa-edit"></i>
                                                        </a>


                                                        <button type="button" class="btn btn-danger" id="delete_nationality"
                                                            data-id="<?php echo $rows['nationality_id']; ?>">
