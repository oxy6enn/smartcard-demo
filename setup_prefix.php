            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">คำนำหน้า</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header ">
                            <div class="d-flex">
                                <h3 class="card-title align-self-center">คำนำหน้าทั้งหมด</h3>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">เพิ่มคำนำหน้า</h4>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " id="prefix_name"
                                                    name="prefix_name" placeholder="ชื่อคำนำหน้า">
                                            </div>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="submit" name="prefix_add"
                                    ...
                                    <div class="col-sm-12">
                                        <table id="example2"
                                            ...
                                            ?>
                                                ...
                                                <tr class="odd">
                                                    <td> <?php echo $r ++  ?></td>
                                                    <td> <?php echo $rows["prefix_name"]; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="setup_prefix_edit.php?prefix_id=<?php echo $rows["prefix_id"]; ?>"
                                                            class="btn btn-warning"><i class="fas fa-edit"></i>
                                                        </a>


                                                        <button type="button" class="btn btn-danger" id="delete_prefix"
                                                            data-id="<?php echo $rows['prefix_id']; ?>">
